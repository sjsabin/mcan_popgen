...
#stashcp /osgconnect/public/sjsabin/er_convert_out.tar.gz ./
# Extract the fasta files
tar xvf er_convert_out.tar.gz

REP=er.$1

echo "0.002399 100 201 0 0 1 1 1" | LDhat-master/pairwise -seq er_convert_out/${REP}.sites.txt -loc er_convert_out/${REP}.locs.txt -prefix ${REP}. >> ${REP}.pw.log
